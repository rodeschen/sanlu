...
document.write( "<font size=2 color='ff00ff'>�i���� �褸 " + SolarYear + "�~" + SolarMonth + "��" + SolarDate + "�� -- " );
document.write( "�A�� " + LunarMonth + "�� " + LunarDate + "�� -- " );

document.write( "��" + Location + " -- �R" + Animal + Age + " ���j</font>" ); 
