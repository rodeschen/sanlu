...
<body>
					...
					var grid1 = $("#grid1").jqGrid(
							{
								...
								onSortCol : function(index, iCol, sortorder) {
									index.match("startTime|endTime")
											&& grid1.groupingGroupBy('date', {
	...
	<fieldset>
		...
		<div>
			...
			<button id="calendar" style="float: right;">開啟行事曆</button>
		</div>
		<div id="grid1" />
	</fieldset>
	<div class="hide">
		<div id="pdialog" class="dialog" style="display: block; width: 470px;">
			<g:form name="addForm" id="addForm" onsubmit="return false;"
				...
				<div class="dialog-body">
					<div class="field-row">
						<span class="th2">事項：</span> <span><input type="text"
							id="description" name="description" placeholder="事項" size="45"
							class="validate[required]" /></span>
					</div>
					<div class="field-row startTime">
						<span class="th2">開始時間：</span> <span><input type="text"
							class="validate[required] date" id="startDate" name="startDate"
							size="12" /></span><span><span class="timeSelect"> <select
								id="startHour" name="startHour" class="timeSelect">
