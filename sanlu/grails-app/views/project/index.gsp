							...
							<div id="productArea" style="">
								<div id="type1" class="productArea" style="">
									<div class="field-row">
										...
										<span>
											<select
											id="product1" name="product1" class="validate[required]">
												<option value="">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</option>
											</select>
										</span>
									</div>
									<div class="field-row">
										...
										<span>
											<input
											id="amount1" name="amount1" class="validate[required]" />
										</span>
									</div>
									<div class="field-row">
										<span class="th1">時間：</span>
										<span>
											<input type="text"
											class="validate[required] date" id="date1" name="date1" size="10" />
										</span>
										<span>
								...
								<div id="type2" class="productArea" style="display:none;">
									<div class="field-row">
										...
										<span>
											<select
											id="product2" name="product2" class="validate[required]">
												<option value="">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</option>
											</select>
										</span>
									</div>
									<div class="field-row">
										...
										<span>
											<input
											id="amount2" name="amount2" class="validate[required]" />
										</span>
									</div>
									<div class="field-row">
										...
										<span>
											<input
											id="vendor2" name="vendor2" class="validate[required]" />
										</span>
									</div>
									<div class="field-row">
										<span class="th1">時間：</span>
										<span>
											<input type="text"
											class="validate[required] date" id="date2" name="date2" size="10" />
										</span>
										<span>
								...
								<div id="type3" class="productArea" style="display:none";>
									<div class="field-row">
										...
										<span>
											<select
											id="product3" name="product3" class="validate[required]">
												<option value="">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</option>
											</select>
										</span>
									</div>
									<div class="field-row">
										...
										<span>
											<select
											id="place3" name="place3" class="validate[required]">
												<option value="">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</option>
											</select>
										</span>
									</div>
									<div class="field-row">
										...
										<span>
											<input type="text"
											class="validate[required] date" id="startDate3" name="startDate3" size="10" />
										</span>
										<span>
									...
									<div class="field-row">
										...
										<span>
											<input type="text"
											class="validate[required] date" id="endDate3" name="endDate3" size="10" />
										</span>
										<span>
