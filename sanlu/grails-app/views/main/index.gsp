                ...
                <g:form name="loginForm" url="[action:'login',controller:'login']">
                    <fieldset style="width:330px;margin:80px auto 0;">
                        ...
                        <div class="field-row">
                            ...
                            <span><input type="text" id="id" name="id" placeholder="帳號" required/></span>
                        </div>
                        <div class="field-row">
                            <span class="th1">密碼：</span>
                            <span><input type="password" id="pw" name="pw" placeholder="密碼" required/></span>
                        </div><!--
                        <div class="field-row">
        ...
        <g:else>
            ...
            <div class="hide">
                <div id="pdialog" class="dialog" style="display:block;width:400px;">
                    <g:form name="loginForm" onsubmit="return false;">
                        <div class="dialog-body">
                            <div class="field-row">
                                <span class="th1">案名：</span>
                                <span><input type="text" id="projectName" name="projectName" placeholder="姓名" required/></span>
                            </div>
                            <div class="field-row">
